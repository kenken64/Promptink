...
export const translations = {
  en: {
    ...
    placeholderEdit: "Describe what should appear in the marked area (e.g., 'cobblestone pavement')...",
    ...
    syncing: "Syncing...",
    syncSuccess: "Synced!",
    selectDevices: "Select devices to sync",
    ...
    infographicGuide: {
      ...
      tip1: "Paste a GitHub .md URL to auto-generate",
      tip2: 'Type "infographic about..." + your topic',
      tip3: "Works with bullet points, lists, or paragraphs",
    },
    imageSize: "Size",
    sizeSquare: "Square",
    ...
    auth: {
      ...
      register: {
        ...
        weakPassword: "Password must be at least 8 characters and include a number or special character.",
      ...
      forgotPassword: {
        ...
        successMessage: "If an account exists with this email, you'll receive a password reset link shortly.",
      },
      resetPassword: {
    ...
    purchase: {
      ...
      alreadyOwnDevice: "I already own a TRMNL device",
      saving: "Saving...",
    ...
    gallery: {
      ...
      deleting: "Deleting...",
      bulkDeleteConfirm: "Delete {count} images?",
      bulkDeleteSuccess: "{count} images deleted",
      bulkExportSuccess: "Export downloaded",
      bulkShareSuccess: "Share link created",
      shareGalleryTitle: "Shared Gallery",
      maxSelectExport: "Max 20 for export",
    },
    schedule: {
      title: "Schedule",
    ...
    collections: {
      ...
      namePlaceholder: "e.g., Landscapes",
      description: "Description (optional)",
      descriptionPlaceholder: "What's this collection about?",
      noCollections: "No collections yet",
      noCollectionsHint: "Create a collection to organize your images.",
      addToCollection: "Add to Collection",
      removeFromCollection: "Remove from Collection",
      manageCollections: "Manage Collections",
      deleteConfirm: "Delete this collection? Images won't be deleted.",
      imageCount: "{count} images",
      imageCountSingular: "{count} image",
      allCollections: "All",
  ...
  zh: {
    ...
    placeholderEdit: "描述标记区域应显示的内容（例如：'鹅卵石路面'）...",
    ...
    syncing: "同步中...",
    syncSuccess: "已同步！",
    selectDevices: "选择要同步的设备",
    selectAll: "全选",
    syncSelected: "同步",
    noDevicesConfigured: "未配置设备",
    share: "分享",
    sharing: "创建链接...",
    shareSuccess: "链接已就绪！",
    copyLink: "复制",
    ...
    auth: {
      ...
      register: {
        ...
        weakPassword: "密码至少需要8个字符，并包含数字或特殊字符。",
      ...
      forgotPassword: {
        ...
        successMessage: "如果该邮箱存在账户，您将很快收到密码重置链接。",
      },
      resetPassword: {
        title: "重置密码",
        subtitle: "在下方输入您的新密码",
    ...
    settings: {
      ...
      devices: {
        ...
        addDevice: "添加设备",
        deviceName: "设备名称",
        deviceNamePlaceholder: "例如：客厅显示屏",
        noDevices: "尚未配置设备。添加您的第一个 TRMNL 设备开始使用。",
    ...
    purchase: {
      ...
      processing: "处理中...",
      skipForNow: "暂时跳过",
      alreadyOwnDevice: "我已拥有 TRMNL 设备",
      saving: "保存中...",
    ...
    gallery: {
      ...
      bulkShare: "分享所选",
      deleting: "删除中...",
      bulkDeleteConfirm: "删除 {count} 张图片？",
      bulkDeleteSuccess: "已删除 {count} 张图片",
      bulkExportSuccess: "导出已下载",
      bulkShareSuccess: "分享链接已创建",
      shareGalleryTitle: "共享图库",
      maxSelectExport: "导出最多20张",
    },
    schedule: {
      title: "定时任务",
    ...
    collections: {
      ...
      create: "创建合集",
      name: "合集名称",
      namePlaceholder: "例如：风景",
      description: "描述（可选）",
      descriptionPlaceholder: "这个合集关于什么？",
      noCollections: "暂无合集",
      noCollectionsHint: "创建一个合集来整理您的图片。",
      addToCollection: "添加到合集",
      removeFromCollection: "从合集移除",
      manageCollections: "管理合集",
      deleteConfirm: "删除此合集？图片不会被删除。",
      imageCount: "{count} 张图片",
      imageCountSingular: "{count} 张图片",
      allCollections: "全部",
      createNew: "新建...",
