            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={cn(
                    "w-full pl-10 pr-12 py-3 bg-slate-900/50 border rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 transition-all",
                    confirmPassword && password !== confirmPassword
                      ? "border-red-500/50 focus:ring-red-500/50 focus:border-red-500"
                      : "border-slate-700 focus:ring-teal-500/50 focus:border-teal-500"
                  )}
                />
                <button
                  type="button"
